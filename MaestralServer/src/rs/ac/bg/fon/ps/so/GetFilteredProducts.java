 ...
 * @author Katarina
 */
public class GetFilteredProducts extends AbstractSystemOperation {

    private final List<String> columns;
    private final List<Object> values;
    private List<Product> products;

    public GetFilteredProducts(List<String> columns, List<Object> values) {
    ...
    protected void executeSpecificOperation() throws Exception {
        products = (List<Product>) repository.getAll(new Product(), columns, values);
